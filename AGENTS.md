...
- **Framework & Libraries:** React, Tailwind CSS 4, Typescript, Zustand (State Management), Framer Motion atau GSAP (Animation).
...
1. **Analysis:** Baca `README.md`, `style-guide.md`, folder `/design`, dan `/public/assets`. Diskusikan rencana struktur komponen.
